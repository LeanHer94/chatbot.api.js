/*
Deployment script for ChatBotDatabase
...
GO
:setvar DatabaseName "ChatBotDatabase"
:setvar DefaultFilePrefix "ChatBotDatabase"
...
GO
PRINT N'Creating [dbo].[requestsCache]...';


GO
CREATE TABLE [dbo].[requestsCache] (
    [id]               INT          IDENTITY (1, 1) NOT NULL,
    [timezone]         VARCHAR (50) NULL,
    [time_at_timezone] DATETIME     NULL,
...
GO
PRINT N'Creating [dbo].[FK_request_zone]...';


GO
ALTER TABLE [dbo].[requests]
    ADD CONSTRAINT [FK_request_zone] FOREIGN KEY ([zone_id]) REFERENCES [dbo].[zones] ([id]);
